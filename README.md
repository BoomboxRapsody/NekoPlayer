...
Please also note that app resources are covered by a separate licence. Please see the [licence](https://github.com/BoomboxRapsody/NekoPlayer/tree/master/NekoPlayer.App/BuiltInResources/LICENSE.md) for clarifications.
