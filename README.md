...
This app uses `spine-csharp` (located as Spine in the source code) the C# Spine Runtime. Please see [Spine Runtimes License](https://esotericsoftware.com/spine-runtimes-license) for more information.
