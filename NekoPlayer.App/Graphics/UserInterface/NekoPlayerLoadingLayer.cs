...
namespace NekoPlayer.App.Graphics.UserInterface
{
    ...
    /// </summary>
    public partial class NekoPlayerLoadingLayer : NekoPlayerLoadingSpinner
    {
        ...
        public NekoPlayerLoadingLayer(bool dimBackground = false, bool withBox = true, bool blockInput = true)
            : base(withBox, true)
        {
