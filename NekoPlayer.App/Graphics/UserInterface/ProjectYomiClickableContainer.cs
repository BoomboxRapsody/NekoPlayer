...
{
    public partial class ProjectYomiClickableContainer : ClickableContainer, IHasTooltip
    {
        ...
        public ProjectYomiClickableContainer(HoverSampleSet sampleSet = HoverSampleSet.Default)
        {
