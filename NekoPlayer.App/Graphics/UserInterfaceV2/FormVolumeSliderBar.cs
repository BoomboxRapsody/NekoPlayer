...
{
    public partial class FormVolumeSliderBar<T> : CompositeDrawable, IHasCurrentValue<T>, IFormControl
        where T : struct, INumber<T>, IMinMaxValue<T>
    {
        ...
        public partial class InnerSlider : AdaptiveSliderBar<T>
        {
            ...
            protected override void UpdateAfterChildren()
            {
                ...
                /*
                leftBox.Width = Math.Clamp(RangePadding + (nub.DrawPosition.X - 8), 0, Math.Max(0, DrawWidth)) / DrawWidth;
                rightBox.Width = Math.Clamp(DrawWidth - (nub.DrawPosition.X + 8) - RangePadding, 0, Math.Max(0, DrawWidth)) / DrawWidth;
                */
