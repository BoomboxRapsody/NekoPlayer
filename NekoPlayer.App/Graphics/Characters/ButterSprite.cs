...
{
    public partial class ButterSprite : SpineSprite
    {
        [BackgroundDependencyLoader]
        private void load(LargeTextureStore largeTextureStore)
        {
            using StreamReader atlasReader = OpenStream("Spine/Butter/Butter.atlas.txt");
            Atlas = new Atlas(atlasReader, "Textures/Spine/Butter/", new SpineTextureLoader(largeTextureStore));

            using StreamReader jsonReader = OpenStream("Spine/Butter/Butter.skel.bytes");
