...
{
    public partial class YomiSprite : SpineSprite
    {
        [BackgroundDependencyLoader]
        private void load(LargeTextureStore largeTextureStore)
        {
            using StreamReader atlasReader = OpenStream("Spine/Yomi/Yomi.atlas.txt");
            Atlas = new Atlas(atlasReader, "Textures/Spine/Yomi/", new SpineTextureLoader(largeTextureStore));

            using StreamReader jsonReader = OpenStream("Spine/Yomi/Yomi.skel.bytes");
